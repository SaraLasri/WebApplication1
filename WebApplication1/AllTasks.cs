namespace WebApplication1
{
    public static class AllTasks
    {
        ...
        new TaskModel(5, "ppp","purple", DateTime.Now,Preferance.a),
        new TaskModel(6,"lll","yellow", DateTime.Now,Preferance.a),
        new TaskModel(7, "kkk","pink", DateTime.Now,Preferance.a),
